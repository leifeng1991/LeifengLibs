...
public final class AppUtils {
    ...
    public static void installApp(final File file, final String authority) {
        ...
        BaseApplication.getBaseApplication().startActivity(IntentUtils.getInstallAppIntent(file, authority, true));
    }
    ...
    public static void uninstallApp(final String packageName) {
        ...
        BaseApplication.getBaseApplication().startActivity(IntentUtils.getUninstallAppIntent(packageName, true));
    }
    ...
    public static boolean isAppDebug() {
        return isAppDebug(BaseApplication.getBaseApplication().getPackageName());
    }
    ...
    public static boolean isAppSystem() {
        return isAppSystem(BaseApplication.getBaseApplication().getPackageName());
    }
    ...
    public static boolean isAppForeground() {
        ...
        for (ActivityManager.RunningAppProcessInfo aInfo : info) {
            if (aInfo.importance == ActivityManager.RunningAppProcessInfo.IMPORTANCE_FOREGROUND) {
                return aInfo.processName.equals(BaseApplication.getBaseApplication().getPackageName());
            }
        }
        return false;
    }
    ...
    public static void launchApp(final String packageName) {
        if (isSpace(packageName)) return;
        BaseApplication.getBaseApplication().startActivity(IntentUtils.getLaunchAppIntent(packageName, true));
    }
    ...
    public static void launchAppDetailsSettings() {
        launchAppDetailsSettings(BaseApplication.getBaseApplication().getPackageName());
    }
    ...
    public static void launchAppDetailsSettings(final String packageName) {
        if (isSpace(packageName)) return;
        BaseApplication.getBaseApplication().startActivity(
    ...
    public static Drawable getAppIcon() {
        return getAppIcon(BaseApplication.getBaseApplication().getPackageName());
    }
    ...
    public static String getAppPackageName() {
        return BaseApplication.getBaseApplication().getPackageName();
    }
    ...
    public static String getAppName() {
        return getAppName(BaseApplication.getBaseApplication().getPackageName());
    }
    ...
    public static String getAppPath() {
        return getAppPath(BaseApplication.getBaseApplication().getPackageName());
    }
    ...
    public static String getAppVersionName() {
        return getAppVersionName(BaseApplication.getBaseApplication().getPackageName());
    }
    ...
    public static int getAppVersionCode() {
        return getAppVersionCode(BaseApplication.getBaseApplication().getPackageName());
    }
    ...
    public static Signature[] getAppSignature() {
        return getAppSignature(BaseApplication.getBaseApplication().getPackageName());
    }
    ...
    public static String getAppSignatureSHA1() {
        return getAppSignatureSHA1(BaseApplication.getBaseApplication().getPackageName());
    }
    ...
    public static AppInfo getAppInfo() {
        return getAppInfo(BaseApplication.getBaseApplication().getPackageName());
    }
