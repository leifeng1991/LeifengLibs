...
public class CrashUtils implements UncaughtExceptionHandler {
     ...
     * 不需要包含 SD 根目录
     */
    public CrashUtils(Context context, OnCrashListener onCrashListener) {
     ...
     * 不需要包含 SD 根目录
     */
    public CrashUtils(Context context, String logPath) {
     ...
     * 不需要包含 SD 根目录
     */
    private CrashUtils(Context context, String logPath, OnCrashListener onCrashListener) {
