...
public final class SDCardUtils {
    ...
    public static List<String> getSDCardPaths(final boolean removable) {
        ...
        StorageManager sm =
                (StorageManager) BaseApplication.getBaseApplication().getSystemService(Context.STORAGE_SERVICE);
        try {
    ...
    public static List<String> getSDCardPaths() {
        StorageManager storageManager = (StorageManager) BaseApplication.getBaseApplication()
