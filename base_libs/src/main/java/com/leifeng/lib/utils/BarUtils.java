...
public final class BarUtils {
    ...
    public static int getActionBarHeight() {
        ...
        if (BaseApplication.getBaseApplication().getTheme().resolveAttribute(android.R.attr.actionBarSize, tv, true)) {
            return TypedValue.complexToDimensionPixelSize(
                    tv.data, BaseApplication.getBaseApplication().getResources().getDisplayMetrics()
            );
        }
        return 0;
    }
    ...
    private static void invokePanels(final String methodName) {
        try {
            ...
            Object service = BaseApplication.getBaseApplication().getSystemService("statusbar");
    ...
    public static int getNavBarHeight() {
        Resources res = BaseApplication.getBaseApplication().getResources();
